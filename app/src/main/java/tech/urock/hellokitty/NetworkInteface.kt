...
//            }
    ...
    fun sendStatus() {
        ...
        videoConfig["iso"] = 1000
        videoConfig["fullResolution"] = "4k"
        videoConfig["exposure"] = 640
        previewResolution["width"] = 216
        previewResolution["height"] = 384
        videoConfig["previewResolution"] = previewResolution
        videoConfig["previewFps"] = 10
        videoConfig["previewQuality"] = 33
        status_map["videoConfig"] = videoConfig
        status_map["videoDuration"] = 96

        status_map["frame"] = "null"
        ...
        var status_json: JSONObject = JSONObject(status_map as Map<String, Any>?)
        println("${status_json}")
